...
class PhotoCaptureFieldV2 extends StatefulWidget {
  final String label;
  ...
  @override
  State<PhotoCaptureFieldV2> createState() => _PhotoCaptureFieldV2State();
}

class _PhotoCaptureFieldV2State extends State<PhotoCaptureFieldV2> {
  ...
  Future<void> _takePicture() async {
    ...
    try {
      ...
      if (mounted) {
        _showErrorMessage('Error al acceder a la cámara: ${e.toString()}');
      }
    } finally {
      if (mounted) {
        setState(() {
  ...
  Future<void> _pickFromGallery() async {
    ...
    try {
      ...
      if (mounted) {
        _showErrorMessage('Error al acceder a la galería: ${e.toString()}');
      }
    } finally {
      if (mounted) {
        setState(() {
